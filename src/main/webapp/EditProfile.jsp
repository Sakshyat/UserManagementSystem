                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                            ...
                            %>
                            <div class="form-group">       
                                <a href="UserProfile.jsp?username=<%=username%>" class="btn btn-primary">Cancel</a> 
...
<%
    ...
    if (id != null && first_name != null && last_name != null && username != null && email != null && phone != null) {
        String query = "Update user set first_name=?, last_name=?, email=?, phone=? where id='" + id + "'";
        ...
        try {
            ...
            history.userHistory(uname, "Updated profile", datetime);
        } catch (Exception e) {
