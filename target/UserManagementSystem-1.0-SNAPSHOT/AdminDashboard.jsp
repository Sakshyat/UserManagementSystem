                            ...
                            <div class="col-lg-7 mb-4">
                                <div class="card">
                                    <div class="card-header">
                                        <h6 class="text-uppercase mb-0">Recent Top Clients</h6>
                                    </div>
                                    <div class="card-body">
                                        <%    try {
                                                Connection conn = DBConnection.createConnection();
                                                String sql = "Select first_name, last_name from user order by id desc limit 3";
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="card px-5 py-4">
                                    <%
                                        conn = DBConnection.createConnection();
                                        st = conn.createStatement();
                                        String query2 = "SELECT COUNT(*) FROM history";
                                        rs = st.executeQuery(query2);
                                        while (rs.next()) {
                                    %>
                                    <h2 class="mb-0 d-flex align-items-center"><span><%=rs.getString(1)%></span><% }%><span class="dot bg-red d-inline-block ml-3"></span></h2><span class="text-muted">Total number of user interactions</span>
