...
<html class="no-js" lang="zxx">
    ...
    <body>
        ...
        <main>
            <section class="login_part section_padding" style="padding-top:0px">
                <div class="container">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="login_part_text text-center">
                                <div class="login_part_text_iner">
                                    ...
                                    <p>Login now and get started with the awesome user management features</p>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="login_part_form">
                                <div class="login_part_form_iner">
                                    ...
                                    <form class="row contact_form" name="form" action="RegisterServlet" method="post" onsubmit="return validate()">
