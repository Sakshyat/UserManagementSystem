                    ...
                    <section class="py-5">
                        <div class="col-lg-6 mb-4">                           
                            <table class="table table-striped table-hover card-text">
                                <thead>
                                    <tr>
                                <th><h6 class="text-uppercase mb-0">Users</h6><th>
                                <th><a href="AddUser.jsp">Add User</a></th> 
                                    <tr>
                                    <tr>
                                        <th>First Name</th>
                                        <th>Last Name</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="EditUser.jsp?id=<%=rs.getString("id")%>">Edit</a></td>
                                        <td><a href="delete?username=<%=rs.getString("username")%>">Delete</a></td>
                                    </tr>
                                </tbody>
                                <%
                                        }
